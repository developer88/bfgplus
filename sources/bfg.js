...
(function() {
  ...
  Bfg = (function() {
    ...
    function Bfg(options) {
      ...
      this.load_blog_callback = __bind(this.load_blog_callback, this);
    ...
    Bfg.prototype.load_blog = function() {
      return $.getJSON('https://www.googleapis.com/plus/v1/people/' + this.options['user'] + '/activities/public?maxResults=' + this.options['count'] + '&key=' + this.options['api'], this.load_blog_callback);
    };

    Bfg.prototype.load_blog_callback = function(data) {
      var post, _i, _len, _ref;
      this.posts = data['items'];
      if (this.posts.length > 0) {
        this.hide_div_and_prepare_container();
        _ref = this.posts;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          post = _ref[_i];
